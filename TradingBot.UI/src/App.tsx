...
export default function App() {
  ...
  const realMonitor = dashboard?.paperPhase1RealMonitor ?? {};
  ...
  const realMonitorRows = [
    ...
    ['Status', realMonitor.armed && realMonitor.readiness && !realMonitor.realPaperEligible ? 'Armed, waiting for afterSafetyEdge >= 0.01' : (realMonitor.armed ? 'Armed' : 'Not armed')],
