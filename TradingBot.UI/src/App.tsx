...
export default function App() {
  ...
  const opportunityFamilyRows: any[] = [['Label', 'Diagnostics only - not a trade recommendation'], ['Best priced family', runtime(health, 'opportunityFamilyBestPricedFamily') ?? 'N/A'], ['Best after-safety edge', runtime(health, 'opportunityFamilyBestPricedAfterSafetyEdge') ?? 'N/A'], ['Best unpriced verified-like family', runtime(health, 'opportunityFamilyBestUnpricedFamily') ?? 'N/A'], ['Closest to break-even', runtime(health, 'opportunityFamilyClosestToBreakEvenCount') ?? 0], ['Positive families', runtime(health, 'opportunityFamilyPositiveFamilies') ?? 0], ['Executable families', runtime(health, 'opportunityFamilyExecutableFamilies') ?? 0]];
