...
public class MultiOutcomeEnhancementsTests
{
    ...
    {
        var report = new MultiOutcomeGroupArbEngine.MultiOutcomeScanReport(5,0,0,0,5,0,0.1m,0m,0m,"","UnverifiedGroup",new Dictionary<string,int>{{"UnverifiedGroup",5}},new []{"g1:UnverifiedGroup"});
