...
public class VerifiedStabilityAndAllowlistTests
{
    ...
    [Fact] public void Three_positive_is_stable(){ var t=new VerifiedOpportunityStabilityTracker(); t.Track("g",Row("g",0.003m),200,3,0.001m,0.002m); t.Track("g",Row("g",0.0031m),200,3,0.001m,0.002m); var st=t.Track("g",Row("g",0.0032m),200,3,0.001m,0.002m); Assert.Equal(VerifiedBasketState.StableExecutable, st);}    
