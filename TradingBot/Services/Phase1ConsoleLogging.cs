...
public static class Phase1ConsoleLogging
{
    ...
    private static long _exportErrorsBaseline, _exportDroppedBaseline, _criticalExportFailuresBaseline, _nonCriticalExportFailuresBaseline, _retentionDeletedBaseline;
