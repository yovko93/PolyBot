...
public static class Phase1ConsoleLogging
{
    ...
    private static long _exportErrorsBaseline, _exportDroppedBaseline;
    ...
    public static void EmitSummary(TextWriter destination, RuntimeHealthSnapshot h, TradingBotOptions options)
    {
        ...
        var exportHealth = RobustJsonlExportWriter.Snapshot();
        var exportErrors5m = Math.Max(0, exportHealth.ErrorsTotal-_exportErrorsBaseline);
        var exportDropped5m = Math.Max(0, exportHealth.DroppedRecordsTotal-_exportDroppedBaseline);
