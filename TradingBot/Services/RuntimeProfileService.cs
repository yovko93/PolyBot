...
public static class RuntimeProfileService
{
    ...
    public const string ReducedDiagnosticsPaperPhase1 = "ReducedDiagnosticsPaperPhase1";
    public static RuntimeProfileResolution Resolve(string[] args, IConfiguration config)
    {
        ...
        var applied = string.Equals(requested, ReducedDiagnosticsPaperPhase1, StringComparison.OrdinalIgnoreCase) ? ReducedDiagnosticsPaperPhase1 : string.Equals(requested, ReducedDiagnosticsFullStack, StringComparison.OrdinalIgnoreCase) ? ReducedDiagnosticsFullStack : string.Empty;
    ...
    public static void Apply(TradingBotOptions o, RuntimeProfileResolution r)
    {
        ...
        if (!string.Equals(r.AppliedProfile, ReducedDiagnosticsFullStack, StringComparison.OrdinalIgnoreCase) && !string.Equals(r.AppliedProfile, ReducedDiagnosticsPaperPhase1, StringComparison.OrdinalIgnoreCase)) return;
        ...
        o.PaperDiagnosticsLimited.Enabled=true; o.PaperDiagnosticsLimited.RequireExplicitFlag=true; o.PaperDiagnosticsLimited.AllowedStrategy="SingleMarketBuyBoth"; o.PaperDiagnosticsLimited.MaxOpenPositions=1; o.PaperDiagnosticsLimited.MaxPaperNotionalPerTrade=5m; o.PaperDiagnosticsLimited.MaxPaperTotalExposure=5m; o.PaperDiagnosticsLimited.MaxPaperOpensPerHour=1; o.PaperDiagnosticsLimited.MinEdgeOverride=0.01m; o.PaperPhase1DiscoveryFallback.Enabled=string.Equals(r.AppliedProfile, ReducedDiagnosticsPaperPhase1, StringComparison.OrdinalIgnoreCase); o.PaperPhase1DiscoveryFallback.RequireProfile=ReducedDiagnosticsPaperPhase1; o.PaperPhase1DiscoveryFallback.SnapshotPath="exports/reduced-universe-last-healthy-snapshot.json"; o.PaperPhase1DiscoveryFallback.MaxSnapshotAgeHours=24; o.PaperPhase1DiscoveryFallback.MinMarkets=500; o.PaperPhase1DiscoveryFallback.RequireExplicitFlag=true; o.PaperPhase1DiscoveryFallback.AllowWhenGammaTimeout=true; o.PaperPhase1DiscoveryFallback.DiagnosticsOnly=false;
        ...
        o.EnableLiveExecution=false; o.EnablePaperTrading=true; o.PaperOnly=true; o.TradingMode.LiveTradingEnabled=false; o.TradingMode.PaperTradingEnabled=true; o.TradingMode.PaperPhase= string.Equals(r.AppliedProfile, ReducedDiagnosticsPaperPhase1, StringComparison.OrdinalIgnoreCase) ? 1 : 2; o.PaperPhaseValidation.Enabled=false; o.PaperSettlementValidation.Enabled=false;
        ...
        o.SignalRLogNoiseControl.Enabled=true; o.SignalRLogNoiseControl.SuppressPayloadTrimmed=true; o.SignalRLogNoiseControl.PayloadTrimmedSummaryIntervalSeconds=60; o.SignalRLogNoiseControl.PayloadTrimmedFirstNPerRun=3; o.SignalRLogNoiseControl.ExportCounters=true; o.SignalRLogNoiseControl.DiagnosticsOnly=true;
        o.DiagnosticsDashboard.Enabled=true; o.DiagnosticsDashboard.ExportEnabled=true; o.DiagnosticsDashboard.ExportPath="exports/diagnostics-dashboard-latest.json"; o.DiagnosticsDashboard.IncludeTopItems=true; o.DiagnosticsDashboard.TopItemsLimit=10; o.DiagnosticsDashboard.WriteIntervalSeconds=15; o.DiagnosticsDashboard.DiagnosticsOnly=true; o.DiagnosticsDashboardHistory.Enabled=true; o.DiagnosticsDashboardHistory.RequireDiagnosticsDashboard=true; o.DiagnosticsDashboardHistory.ExportEnabled=true; o.DiagnosticsDashboardHistory.HistoryPath="exports/diagnostics-dashboard-history-latest.json"; o.DiagnosticsDashboardHistory.JsonlPath="exports/diagnostics-dashboard-history.jsonl"; o.DiagnosticsDashboardHistory.CsvPath="exports/diagnostics-dashboard-history.csv"; o.DiagnosticsDashboardHistory.SampleIntervalSeconds=60; o.DiagnosticsDashboardHistory.MaxInMemorySamples=1440; o.DiagnosticsDashboardHistory.MaxJsonlFileMb=50; o.DiagnosticsDashboardHistory.CsvEnabled=true; o.DiagnosticsDashboardHistory.JsonlEnabled=true; o.DiagnosticsDashboardHistory.DiagnosticsOnly=true;
    ...
    {
        if (!string.Equals(o.RuntimeProfile, ReducedDiagnosticsFullStack, StringComparison.OrdinalIgnoreCase) && !string.Equals(o.RuntimeProfile, ReducedDiagnosticsPaperPhase1, StringComparison.OrdinalIgnoreCase)) return;
    ...
    public static string StartupLog(TradingBotOptions o)
    {
        ...
        return $"[RUNTIME_PROFILE] RequestedProfile={N(o.RuntimeProfileRequested)} AppliedProfile={N(o.RuntimeProfile)} ProfileSource={o.RuntimeProfileSource} SafetyProfile={N(o.RuntimeProfile)} LiveTradingEnabled={o.TradingMode.LiveTradingEnabled.ToString().ToLowerInvariant()} PaperTradingEnabled={o.TradingMode.PaperTradingEnabled.ToString().ToLowerInvariant()} PaperEligibleStrategies={paper} ShadowStrategies={shadow} DiagnosticsOnlyLayers=AutoCandidatePricing|OpportunityFamilyRanking|FocusUniverse|EdgeTransition|EdgeCompression|SpreadMicrostructure|SignalRLogNoiseControl|DiagnosticsDashboard|DiagnosticsDashboardHistory DiagnosticsDashboard.Enabled={o.DiagnosticsDashboard.Enabled.ToString().ToLowerInvariant()} DiagnosticsDashboard.ExportEnabled={o.DiagnosticsDashboard.ExportEnabled.ToString().ToLowerInvariant()} DiagnosticsDashboard.ExportPath={o.DiagnosticsDashboard.ExportPath} DiagnosticsDashboard.IncludeTopItems={o.DiagnosticsDashboard.IncludeTopItems.ToString().ToLowerInvariant()} DiagnosticsDashboard.TopItemsLimit={o.DiagnosticsDashboard.TopItemsLimit} DiagnosticsDashboard.WriteIntervalSeconds={o.DiagnosticsDashboard.WriteIntervalSeconds} DiagnosticsDashboard.DiagnosticsOnly={o.DiagnosticsDashboard.DiagnosticsOnly.ToString().ToLowerInvariant()} DiagnosticsDashboardHistory.Enabled={o.DiagnosticsDashboardHistory.Enabled.ToString().ToLowerInvariant()} DiagnosticsDashboardHistory.ExportEnabled={o.DiagnosticsDashboardHistory.ExportEnabled.ToString().ToLowerInvariant()} DiagnosticsDashboardHistory.HistoryPath={o.DiagnosticsDashboardHistory.HistoryPath} DiagnosticsDashboardHistory.JsonlPath={o.DiagnosticsDashboardHistory.JsonlPath} DiagnosticsDashboardHistory.CsvPath={o.DiagnosticsDashboardHistory.CsvPath} DiagnosticsDashboardHistory.SampleIntervalSeconds={o.DiagnosticsDashboardHistory.SampleIntervalSeconds} DiagnosticsDashboardHistory.MaxInMemorySamples={o.DiagnosticsDashboardHistory.MaxInMemorySamples} DiagnosticsDashboardHistory.MaxJsonlFileMb={o.DiagnosticsDashboardHistory.MaxJsonlFileMb} DiagnosticsDashboardHistory.CsvEnabled={o.DiagnosticsDashboardHistory.CsvEnabled.ToString().ToLowerInvariant()} DiagnosticsDashboardHistory.JsonlEnabled={o.DiagnosticsDashboardHistory.JsonlEnabled.ToString().ToLowerInvariant()} DiagnosticsDashboardHistory.DiagnosticsOnly={o.DiagnosticsDashboardHistory.DiagnosticsOnly.ToString().ToLowerInvariant()} ProfileOverridesCount={o.RuntimeProfileOverrides.Length} ProfileOverrides=[{string.Join("|",o.RuntimeProfileOverrides)}] SignalRLogNoiseControl.Enabled={o.SignalRLogNoiseControl.Enabled.ToString().ToLowerInvariant()} SignalRLogNoiseControl.SuppressPayloadTrimmed={o.SignalRLogNoiseControl.SuppressPayloadTrimmed.ToString().ToLowerInvariant()} SignalRLogNoiseControl.PayloadTrimmedSummaryIntervalSeconds={o.SignalRLogNoiseControl.PayloadTrimmedSummaryIntervalSeconds} SignalRLogNoiseControl.PayloadTrimmedFirstNPerRun={o.SignalRLogNoiseControl.PayloadTrimmedFirstNPerRun} SignalRLogNoiseControl.ExportCounters={o.SignalRLogNoiseControl.ExportCounters.ToString().ToLowerInvariant()} SignalRLogNoiseControl.DiagnosticsOnly={o.SignalRLogNoiseControl.DiagnosticsOnly.ToString().ToLowerInvariant()}";
    }

    public static void Export(TradingBotOptions o,string processRunId,string root)
    {
        try{var path=Path.Combine(root,"exports/effective-runtime-config-latest.json");Directory.CreateDirectory(Path.GetDirectoryName(path)!);var payload=new{processRunId,generatedAtUtc=DateTime.UtcNow,requestedProfile=o.RuntimeProfileRequested,appliedProfile=o.RuntimeProfile,profileSource=o.RuntimeProfileSource,profileOverrides=o.RuntimeProfileOverrides,safety=new{liveTradingEnabled=o.TradingMode.LiveTradingEnabled||o.EnableLiveExecution,signingAllowed=false,paperTradingEnabled=o.TradingMode.PaperTradingEnabled&&o.EnablePaperTrading,paperDiagnosticsLimitedEnabled=o.PaperDiagnosticsLimited.Enabled,allowedPaperStrategy=o.PaperDiagnosticsLimited.AllowedStrategy,strategyModes=o.Strategies.ToDictionary(x=>x.Key,x=>x.Value.Mode.ToString()),diagnosticsOnlyLayers=new{autoCandidatePricing=o.AutoCandidatePricing.DiagnosticsOnly,opportunityFamilyRanking=o.OpportunityFamilyRanking.DiagnosticsOnly,focusUniverse=o.FocusUniverse.DiagnosticsOnly,edgeTransition=o.EdgeTransition.DiagnosticsOnly,edgeCompression=o.EdgeCompression.DiagnosticsOnly,spreadMicrostructure=o.SpreadMicrostructure.DiagnosticsOnly,signalRLogNoiseControl=o.SignalRLogNoiseControl.DiagnosticsOnly,diagnosticsDashboard=o.DiagnosticsDashboard.DiagnosticsOnly,diagnosticsDashboardHistory=o.DiagnosticsDashboardHistory.DiagnosticsOnly}},config=new{o.MarketDiscovery,o.StrategyOrchestrator,o.Strategies,o.PaperDiagnosticsLimited,o.PaperPhase1DiscoveryFallback,o.SingleMarketOpportunityAudit,o.SingleMarketArb,o.TradingMode,o.PaperPhaseValidation,o.PaperSettlementValidation,o.AutoCandidatePricing,o.OpportunityFamilyRanking,o.FocusUniverse,o.EdgeTransition,o.EdgeCompression,o.SpreadMicrostructure,o.SignalRLogNoiseControl,o.DiagnosticsDashboard,o.DiagnosticsDashboardHistory}};var json=JsonSerializer.Serialize(payload,new JsonSerializerOptions{WriteIndented=true,PropertyNamingPolicy=JsonNamingPolicy.CamelCase});var tmp=path+".tmp";for(var i=0;i<3;i++){try{File.WriteAllText(tmp,json);File.Move(tmp,path,true);break;}catch(IOException) when(i<2){Thread.Sleep(50);}}}catch(Exception ex){Console.WriteLine($"[RUNTIME_PROFILE_EXPORT_WARNING] Error={ex.Message}");}
    }
