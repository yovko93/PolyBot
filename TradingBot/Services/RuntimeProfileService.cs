...
public static class RuntimeProfileService
{
    ...
    public static void Apply(TradingBotOptions o, RuntimeProfileResolution r)
    {
        ...
        o.DiagnosticsDashboard.Enabled=true; o.DiagnosticsDashboard.ExportEnabled=true; o.DiagnosticsDashboard.ExportPath="exports/diagnostics-dashboard-latest.json"; o.DiagnosticsDashboard.IncludeTopItems=true; o.DiagnosticsDashboard.TopItemsLimit=10; o.DiagnosticsDashboard.WriteIntervalSeconds=15; o.DiagnosticsDashboard.DiagnosticsOnly=true;
    ...
    public static void ValidateSafety(TradingBotOptions o)
    {
        ...
        if (!o.AutoCandidatePricing.DiagnosticsOnly||!o.FocusUniverse.DiagnosticsOnly||!o.EdgeTransition.DiagnosticsOnly||!o.EdgeCompression.DiagnosticsOnly||!o.SpreadMicrostructure.DiagnosticsOnly||!o.DiagnosticsDashboard.DiagnosticsOnly) violations.Add("AnalyticsLayersMustBeDiagnosticsOnly");
