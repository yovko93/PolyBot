...
public class PaperPositionBook
{
    ...
    public PaperPosition? AddContractFixturePosition(decimal afterSafetyEdge, decimal minEdge, decimal notional)
    {
        ...
        var position = new PaperPosition
        {
            ...
            IsFixture = true, IsSyntheticCanary = false, CountsTowardNormalRuntime = false, SourceCandidateId = "SingleMarketBuyBoth:fixture-market:contract",
        ...
        string processRunId)
    {
        var position = new PaperPosition
        {
            ...
            CountsTowardNormalRuntime = false,
