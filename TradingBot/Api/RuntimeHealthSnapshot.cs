    ...
    IReadOnlyDictionary<string, TradingBot.Services.StrategyRuntimeCounterSnapshot> StrategyCounters)
{
    ...
    public bool PaperPhase1CanaryConsistent => !PaperPhase1CanaryRealOrderSent && !PaperPhase1CanarySigningAttempted && (!PaperPhase1CanaryOpened || (PaperPhase1CanaryPositionId.StartsWith("CANARY-PHASE1-", StringComparison.OrdinalIgnoreCase) && PaperDiagnosticsLimitedPaperOpened >= 1)) && (!PaperPhase1CanarySettled || (PaperClosedPositions >= 1 && PaperOpenPositions == 0));
    ...
    public long PaperPhase1LadderDepthSufficient => Math.Max(0, SingleMarketExecutionReady + SingleMarketRejectedByFill + SingleMarketRejectedByRisk + PaperPhase1PaperOpened);
    public long PaperPhase1LadderFillPassed => Math.Max(0, SingleMarketExecutionReady + SingleMarketRejectedByRisk + PaperPhase1PaperOpened);
    ...
    public long PaperPhase1LadderOpenAttempted => PaperPhase1OpenAttempts;
    public long PaperPhase1LadderOpened => PaperPhase1PaperOpened;
    ...
    public bool PaperPhase1LadderConsistent => PaperPhase1LadderOpened == PaperPhase1PaperOpened && PaperPhase1LadderPaperEligible == PaperPhase1CandidatesEligible && PaperPhase1LadderPositiveAfterSafety >= PaperPhase1LadderPaperEligible && PaperPhase1LadderValidPriced >= PaperPhase1LadderAfterSafetyComputed && PaperPhase1LadderNearBreakEven <= PaperPhase1LadderAfterSafetyComputed && PaperPhase1LadderOpenAttempted == PaperPhase1OpenAttempts && (PaperPhase1LadderPaperEligible == 0 || (PaperPhase1LadderBestAfterSafetyEdge ?? decimal.MinValue) >= PaperPhase1MinEdge);
