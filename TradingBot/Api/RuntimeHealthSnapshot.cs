    ...
    IReadOnlyDictionary<string, TradingBot.Services.StrategyRuntimeCounterSnapshot> StrategyCounters)
{
    ...
    private static string FormatStrategyRuntimeHealth(string key, TradingBot.Services.StrategyRuntimeCounterSnapshot value)
    {
        ...
        return $"{baseText}:activePositive={value.VerifiedActiveConservativePositive}:rawPositiveOnly={value.VerifiedRawPositiveOnly}:alternatePositive={value.VerifiedAlternateProfilePositive}:experimentalCandidates={value.VerifiedExperimentalProfileCandidate}:wouldOpenIfPaperEligible={value.VerifiedWouldOpenIfPaperEligible}:VerifiedWouldOpenBlockedByStability={value.VerifiedRejectedByStability}:VerifiedWouldOpenBlockedByRisk={value.VerifiedRejectedByRisk}:VerifiedWouldOpenBlockedByFill={value.VerifiedWouldOpenBlockedByFill}:VerifiedWouldOpenBlockedByDepth={value.VerifiedWouldOpenBlockedByDepth}:VerifiedWouldOpenBlockedByMissingNoAsk={value.VerifiedRejectedByMissingNoAsk}:VerifiedWouldOpenBlockedByCostProfile={value.VerifiedRejectedByCostProfile}:VerifiedWouldOpenBlockedByUnknown={value.VerifiedWouldOpenBlockedByUnknown}:diagnosticsOnlyBlocked={value.VerifiedDiagnosticsOnlyBlocked}:executionReady={value.ExecutionReady}:paperOpened={value.PaperOpened}";
    }
...
public static class RuntimeHealthTrendTracker
{
    ...
    private static string FormatStrategySoakStatus(string key, TradingBot.Services.StrategyRuntimeCounterSnapshot value)
    {
        if (key.Equals("VerifiedMultiOutcome", StringComparison.OrdinalIgnoreCase))
            return $"{key}:{value.Mode}:activePositive={value.VerifiedActiveConservativePositive}:wouldOpen={value.VerifiedWouldOpenIfPaperEligible}:blockedStability={value.VerifiedRejectedByStability}:blockedRisk={value.VerifiedRejectedByRisk}:blockedFill={value.VerifiedWouldOpenBlockedByFill}:blockedDepth={value.VerifiedWouldOpenBlockedByDepth}:blockedMissingNoAsk={value.VerifiedRejectedByMissingNoAsk}:blockedCostProfile={value.VerifiedRejectedByCostProfile}:blockedUnknown={value.VerifiedWouldOpenBlockedByUnknown}:diagBlocked={value.VerifiedDiagnosticsOnlyBlocked}";
