...
public static class RuntimeHealthTrendTracker
{
    ...
    private static void ValidateSpreadMicrostructureSoakTelemetry(RuntimeHealthSnapshot health, string spreadMicrostructureStatus)
    {
        if (!health.SpreadMicrostructureEnabled) return;
        string[] required = ["SpreadMicrostructureEnabled=", "SpreadMicrostructureItems=", "SpreadMicrostructureSkippedByOrderbookHealth=", "SpreadMicrostructureWideAskSpread=", "SpreadMicrostructureThinTopBook=", "SpreadMicrostructureBothWideAndThin=", "SpreadMicrostructureAlreadyNearExecutable=", "SpreadMicrostructureDepthSufficient=", "SpreadMicrostructureBestStrategy=", "SpreadMicrostructureBestAfterSafetyEdge=", "SpreadMicrostructureBestMoveNeededToBreakEven=", "SpreadMicrostructureMedianMoveNeededToBreakEven=", "SpreadMicrostructureP95MoveNeededToBreakEven=", "SpreadMicrostructureMinTicksToBreakEven=", "SpreadMicrostructureMedianTicksToBreakEven=", "SpreadMicrostructureDominantCause=", "SpreadMicrostructureConsistent="];
        if (required.All(x => spreadMicrostructureStatus.Contains(x, StringComparison.Ordinal))) return;
        Console.WriteLine("[TELEMETRY_FIELD_MISSING] Layer=SpreadMicrostructure Target=SOAK_STATUS Severity=Warning");
    }
