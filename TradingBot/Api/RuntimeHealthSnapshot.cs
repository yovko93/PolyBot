    ...
    IReadOnlyDictionary<string, TradingBot.Services.StrategyRuntimeCounterSnapshot> StrategyCounters)
{
    public string ToLogLine()
    {
        ...
        return $"[RUNTIME_HEALTH] ProcessRunId={ProcessRunId} StartedAtUtc={StartedAtUtc:O} ScannerInstanceId={ScannerInstanceId} DiagnosticsCounterMismatchCount={DiagnosticsCounterMismatchCount} DiagnosticsCounterMismatchLastReason={DiagnosticsCounterMismatchLastReason} ProcessMb={ProcessMemoryMb} GcMb={GcTotalMemoryMb} WorkingSetMb={WorkingSetMb} Logs={RecentLogsCount} ScannerHistory={ScannerHistoryCount} CandidateSnapshots={CandidateSnapshotCount} RepairHistory={RepairHistoryCount} ExecutionAudit={ExecutionAuditCount} SignalRBuffer={SignalREventBufferCount} OrderbookCache={OrderbookCacheCount} MarketCache={MarketCacheCount} PatchPreviewItems={PatchPreviewItemsCount} SingleMarketOpportunities={SingleMarketOpportunitiesCount} SingleMarketNearMisses={SingleMarketNearMissesCount} SingleMarketDataQualitySamples={SingleMarketDataQualitySamplesCount} SingleMarketExecutions={SingleMarketExecutionsCount} PaperPhase={PaperPhase} PaperOpenPositions={PaperOpenPositions} PaperClosedPositions={PaperClosedPositions} PaperSettlements={PaperSettlements} PaperRealizedPnl={PaperRealizedPnl} PaperLocked={PaperLocked} PaperCash={PaperCash} PaperEquity={PaperEquity} PaperTotalExposure={PaperTotalExposure} PaperOpenCountLastHour={PaperOpenCountLastHour} PaperPretradeRejects={PaperPretradeRejects} PaperDuplicateSuppressions={PaperDuplicateSuppressions} PaperOpenPositionKeys={string.Join("|", PaperOpenPositionKeys)} PaperOpenMarketIdsCount={PaperOpenMarketIdsCount} PaperOpenMarketIdsSample={string.Join("|", PaperOpenMarketIdsSample)} PaperInFlightOpens={PaperInFlightOpens} PaperDuplicateDedupeEntries={PaperDuplicateDedupeEntries} PaperStaleDedupeEntriesCleared={PaperStaleDedupeEntriesCleared} PaperSettlementRejects={PaperSettlementRejects} PaperDuplicateSettlementSuppressions={PaperDuplicateSettlementSuppressions} PaperLifecycleEvents={PaperLifecycleEvents} PaperOpenEvents={PaperOpenEvents} PaperCloseEvents={PaperCloseEvents} LiveTradingBlocked={LiveTradingBlockedCount} PaperExecutions={PaperExecutionsCount} SigningAttempts={SigningAttempts} DuplicateGroupKeyWarnings={DuplicateGroupKeyWarnings} QuietSuppressed={QuietSuppressedTotal} EmittedLogs={EmittedLogs} LogGateCache={LogGateCacheSize} QuietSuppressedByCategory={{{suppressed}}} EmittedByCategory={{{emitted}}} BatchBookRequests={BatchBookRequests} BatchBookBadRequests={BatchBookBadRequests} BatchBookTimeouts={BatchBookTimeouts} BatchBookRetrySuccesses={BatchBookRetrySuccesses} BatchBookInvalidTokens={BatchBookInvalidTokens} BatchBookSuppressedErrors={BatchBookSuppressedErrors} BatchBookSplitRetriesAttempted={BatchBookSplitRetriesAttempted} BatchBookSplitRetrySucceeded={BatchBookSplitRetrySucceeded} BatchBookSplitRetryFailed={BatchBookSplitRetryFailed} BatchBookSingleTokenFailures={BatchBookSingleTokenFailures} BatchBookSingleTokenQuarantined={BatchBookSingleTokenQuarantined} BatchBookSkippedQuarantinedTokens={BatchBookSkippedQuarantinedTokens} BatchBookSkippedMarketsWithQuarantinedTokens={BatchBookSkippedMarketsWithQuarantinedTokens} OrderbookUnavailableMarkets={OrderbookUnavailableMarkets} InvalidTokenQuarantineActive={InvalidTokenQuarantineActive} InvalidTokenQuarantineAdded={InvalidTokenQuarantineAdded} InvalidTokenQuarantineExpired={InvalidTokenQuarantineExpired} BatchBookRequestsAvoidedByQuarantine={BatchBookRequestsAvoidedByQuarantine} MarketsSkippedByInvalidTokenQuarantine={MarketsSkippedByInvalidTokenQuarantine} MarketOrderbookQuarantineActive={MarketOrderbookQuarantineActive} MarketOrderbookQuarantineAdded={MarketOrderbookQuarantineAdded} MarketOrderbookQuarantineExpired={MarketOrderbookQuarantineExpired} MarketsSkippedByMarketOrderbookQuarantine={MarketsSkippedByMarketOrderbookQuarantine} BatchBookRequestsAvoidedByMarketQuarantine={BatchBookRequestsAvoidedByMarketQuarantine} OrderbookCircuitBreakerActive={OrderbookCircuitBreakerActive.ToString().ToLowerInvariant()} OrderbookCircuitBreakerState={OrderbookCircuitBreakerState} OrderbookCircuitBreakerOpenCount={OrderbookCircuitBreakerOpenCount} OrderbookCircuitBreakerCooldownRemainingSeconds={OrderbookCircuitBreakerCooldownRemainingSeconds} OrderbookCircuitBreakerHalfOpenAttempts={OrderbookCircuitBreakerHalfOpenAttempts} OrderbookCircuitBreakerHalfOpenSucceeded={OrderbookCircuitBreakerHalfOpenSucceeded} OrderbookCircuitBreakerHalfOpenFailed={OrderbookCircuitBreakerHalfOpenFailed} BatchBookCanaryTimeouts={BatchBookCanaryTimeouts} BatchBookCanaryInvalidTokens={BatchBookCanaryInvalidTokens} BatchBookCanaryOrderbookUnavailable={BatchBookCanaryOrderbookUnavailable} OrderbookCircuitBreakerLastHalfOpenFailureReason={OrderbookCircuitBreakerLastHalfOpenFailureReason} OrderbookCircuitBreakerCooldownExtensions={OrderbookCircuitBreakerCooldownExtensions} OrderbookCircuitBreakerLastOpenReason={OrderbookCircuitBreakerLastOpenReason} OrderbookCircuitBreakerRecoveringSinceUtc={(OrderbookCircuitBreakerRecoveringSinceUtc.HasValue ? OrderbookCircuitBreakerRecoveringSinceUtc.Value.ToString("O") : "")} OrderbookCircuitBreakerRecoveryRemainingSeconds={OrderbookCircuitBreakerRecoveryRemainingSeconds} OrderbookCircuitBreakerReopenedAfterClose={OrderbookCircuitBreakerReopenedAfterClose} OrderbookRequestsBlockedByCircuitBreaker={OrderbookRequestsBlockedByCircuitBreaker} OrderbookPostCloseBadRequests={OrderbookPostCloseBadRequests} OrderbookPostCloseInvalidTokens={OrderbookPostCloseInvalidTokens} SingleTokenIsolationBudgetExhausted={SingleTokenIsolationBudgetExhausted} BatchBookBadRequestsPreventedEstimate={BatchBookBadRequestsPreventedEstimate} BatchBookCanaryRequests={BatchBookCanaryRequests} BatchBookCanaryBadRequests={BatchBookCanaryBadRequests} BatchBookRecoveryRequests={BatchBookRecoveryRequests} BatchBookRecoveryBadRequests={BatchBookRecoveryBadRequests} OrderbookRecoveryLimitedRequests={OrderbookRecoveryLimitedRequests} OrderbookRecoveryLimitedMarkets={OrderbookRecoveryLimitedMarkets} OrderbookRecoveryBadRequests={OrderbookRecoveryBadRequests} OrderbookRecoveryInvalidTokens={OrderbookRecoveryInvalidTokens} OrderbookRecoverySucceededCount={OrderbookRecoverySucceededCount} OrderbookRecoveryFailedCount={OrderbookRecoveryFailedCount} BatchBookNormalRequests={BatchBookNormalRequests} BatchBookNormalBadRequests={BatchBookNormalBadRequests} BatchBookNormalRequestsBeforeBreakerOpen={BatchBookNormalRequestsBeforeBreakerOpen} BatchBookNormalBadRequestsBeforeBreakerOpen={BatchBookNormalBadRequestsBeforeBreakerOpen} BatchBookNormalRequestsAfterBreakerOpen={BatchBookNormalRequestsAfterBreakerOpen} BatchBookNormalBadRequestsAfterBreakerOpen={BatchBookNormalBadRequestsAfterBreakerOpen} QuarantinedMarketsReintroducedBlocked={QuarantinedMarketsReintroducedBlocked} QuarantinedTokensReintroducedBlocked={QuarantinedTokensReintroducedBlocked} AllowlistHealthy={AllowlistHealthy} AllowlistMonitoringOnly={AllowlistMonitoringOnly} AllowlistNeedsPricingPrune={AllowlistNeedsPricingPrune} AllowlistNeedsRefresh={AllowlistNeedsRefresh} AllowlistReviewOnly={AllowlistReviewOnly} AllowlistMismatch={AllowlistMismatch} AllowlistBrokenConfig={AllowlistBrokenConfig} AllowlistDisabled={AllowlistDisabled} AllowlistIgnored={AllowlistIgnored} AllowlistClassificationTotal={AllowlistClassificationTotal} AllowlistClassificationValid={AllowlistClassificationValid.ToString().ToLowerInvariant()} AllowlistRefreshPreviewCandidates={AllowlistRefreshPreviewCandidates} AllowlistRefreshHighConfidence={AllowlistRefreshHighConfidence} AllowlistRefreshFinalNoCandidate={AllowlistRefreshFinalNoCandidate} AllowlistRefreshFinalSemanticConflict={AllowlistRefreshFinalSemanticConflict} AllowlistRefreshFinalLowConfidence={AllowlistRefreshFinalLowConfidence} AllowlistRefreshFinalUnstable={AllowlistRefreshFinalUnstable} AllowlistRefreshFinalPreviewOnly={AllowlistRefreshFinalPreviewOnly} AllowlistRefreshFinalLockedManualReview={AllowlistRefreshFinalLockedManualReview} AllowlistRefreshActionExplainedSuppressed={AllowlistRefreshActionExplainedSuppressed} AllowlistRefreshUnstableGroups={AllowlistRefreshUnstableGroups} AllowlistRefreshActionFlipFlops={AllowlistRefreshActionFlipFlops} AllowlistRefreshAutoApply={AllowlistRefreshAutoApply.ToString().ToLowerInvariant()} DiscoveryHealthy={DiscoveryHealthy.ToString().ToLowerInvariant()} DiscoveryUsingLastHealthySnapshot={DiscoveryUsingLastHealthySnapshot.ToString().ToLowerInvariant()} DiscoveryLastHealthySnapshotAgeSeconds={DiscoveryLastHealthySnapshotAgeSeconds} DiscoveryPartialAttemptCount={DiscoveryPartialAttemptCount} DiscoveryLastFailureReason={DiscoveryLastFailureReason} ScannerPausedByDiscoveryGuard={ScannerPausedByDiscoveryGuard.ToString().ToLowerInvariant()} DiscoveryGuardSkippedCycles={DiscoveryGuardSkippedCycles} DiscoveryGuardUsingLastHealthySnapshot={DiscoveryGuardUsingLastHealthySnapshot.ToString().ToLowerInvariant()} DiscoveryGuardBlockedNewMarkets={DiscoveryGuardBlockedNewMarkets} LongRunStable={LongRunStable.ToString().ToLowerInvariant()} LongRunBlockingReason={LongRunBlockingReason} DiscoveryStable={DiscoveryStable.ToString().ToLowerInvariant()} OrderbookRecoveredAfterDegradation={OrderbookRecoveredAfterDegradation.ToString().ToLowerInvariant()} LastDegradationUtc={(LastDegradationUtc.HasValue ? LastDegradationUtc.Value.ToString("O") : "")} LastRecoveryUtc={(LastRecoveryUtc.HasValue ? LastRecoveryUtc.Value.ToString("O") : "")} DiscoveryBootstrapHealthy={DiscoveryBootstrapHealthy.ToString().ToLowerInvariant()} DiscoveryBootstrapRetryCount={DiscoveryBootstrapRetryCount} DiscoveryBootstrapLastAttemptUtc={(DiscoveryBootstrapLastAttemptUtc.HasValue ? DiscoveryBootstrapLastAttemptUtc.Value.ToString("O") : "")} DiscoveryBootstrapNextRetryUtc={(DiscoveryBootstrapNextRetryUtc.HasValue ? DiscoveryBootstrapNextRetryUtc.Value.ToString("O") : "")} DiscoveryBootstrapBackoffSeconds={DiscoveryBootstrapBackoffSeconds} DiscoveryBootstrapFailureReason={DiscoveryBootstrapFailureReason} DiscoveryRetryBackoffSeconds={DiscoveryRetryBackoffSeconds} DiscoveryRetriesSuppressedByBackoff={DiscoveryRetriesSuppressedByBackoff} DiscoveryPersistedSnapshotLoaded={DiscoveryPersistedSnapshotLoaded.ToString().ToLowerInvariant()} DiscoveryPersistedSnapshotAgeSeconds={DiscoveryPersistedSnapshotAgeSeconds} DiscoveryPersistedSnapshotActiveMarkets={DiscoveryPersistedSnapshotActiveMarkets} AllowlistEvaluationSkipped={AllowlistEvaluationSkipped.ToString().ToLowerInvariant()} AllowlistEvaluationSkippedReason={AllowlistEvaluationSkippedReason} AllowlistClassificationBlockedByDiscovery={AllowlistClassificationBlockedByDiscovery.ToString().ToLowerInvariant()} DiscoveryBlockedReason={DiscoveryBlockedReason} DiscoverySelectedSource={DiscoverySelectedSource} DiscoveryScannerSafeSourceAvailable={DiscoveryScannerSafeSourceAvailable.ToString().ToLowerInvariant()} DiscoverySourceAuditOnly={DiscoverySourceAuditOnly.ToString().ToLowerInvariant()} DiscoverySourceAuditExportWritten={DiscoverySourceAuditExportWritten.ToString().ToLowerInvariant()} DiscoverySourceAuditExportPath={DiscoverySourceAuditExportPath} DiscoverySourceAuditSources={DiscoverySourceAuditSources} DiscoverySourceAuditScannerSafeSources={DiscoverySourceAuditScannerSafeSources} DiscoverySourceAuditRecommendedAction={DiscoverySourceAuditRecommendedAction} SoakReadiness={SoakReadiness} SoakReadinessReason={SoakReadinessReason} Strategies={{{strategies}}} StrategyScanCounts={{{strategyScanCounts}}} StrategyCandidates={{{strategyCandidates}}} StrategyPositiveEdges={{{strategyPositiveEdges}}} StrategyExecutionReady={{{strategyExecutionReady}}} StrategyPaperOpened={{{strategyPaperOpened}}} StrategyRejectedByReason={{{strategyRejectedByReason}}} Uptime={Uptime}";
    }
