...
public class BotRuntimeState
{
    ...
    public DiscoveryHealthDto DiscoveryHealth { get; private set; } = new(true, false, false, "Full", 0, 0, 0, "NotStarted", null, false, 0, 0, DateTime.UtcNow, true);
    ...
    public void SetDiscoveryHealth(DiscoveryHealthDto d){lock(_gate) DiscoveryHealth=d;}
