...
public static class RuntimeSoakStatusExporter
{
    ...
    public static string Export(BotRuntimeState state, TradingBotOptions options, string contentRootPath)
    {
        ...
        var payload = new
        {
            ...
            paperPhase1PositiveCaptureEnabled = health.PaperPhase1PositiveCaptureEnabled,
            paperPhase1PositiveCaptureThreshold = health.PaperPhase1PositiveCaptureThreshold,
            paperPhase1PositiveCapturesTotal = health.PaperPhase1PositiveCapturesTotal,
            paperPhase1PositiveCapturesAboveMinEdge = health.PaperPhase1PositiveCapturesAboveMinEdge,
            paperPhase1PositiveCapturesPaperEligible = health.PaperPhase1PositiveCapturesPaperEligible,
            paperPhase1PositiveCapturesOpened = health.PaperPhase1PositiveCapturesOpened,
            paperPhase1PositiveBestCapturedAfterSafetyEdge = health.PaperPhase1PositiveBestCapturedAfterSafetyEdge,
            paperPhase1PositiveBestCapturedCandidateId = health.PaperPhase1PositiveBestCapturedCandidateId,
            paperPhase1PositiveBestCapturedFirstBlockingReason = health.PaperPhase1PositiveBestCapturedFirstBlockingReason,
            paperPhase1PositiveCaptureConsistent = health.PaperPhase1PositiveCaptureConsistent,
            paperPhase1PositiveCaptureExportWritten = health.PaperPhase1PositiveCaptureExportWritten,
            paperPhase1PositiveCaptureLastWriteError = health.PaperPhase1PositiveCaptureLastWriteError,
            paperPhase1ValidPositiveCapturesTotal = health.PaperPhase1ValidPositiveCapturesTotal,
            paperPhase1ValidPositiveCapturesAboveMinEdge = health.PaperPhase1ValidPositiveCapturesAboveMinEdge,
            paperPhase1ValidPositiveCapturesPaperEligible = health.PaperPhase1ValidPositiveCapturesPaperEligible,
            paperPhase1ValidPositiveCapturesOpened = health.PaperPhase1ValidPositiveCapturesOpened,
            paperPhase1ValidPositiveBestAfterSafetyEdge = health.PaperPhase1ValidPositiveBestAfterSafetyEdge,
            paperPhase1ValidPositiveBestCandidateId = health.PaperPhase1ValidPositiveBestCandidateId,
            paperPhase1ValidPositiveBestFirstBlockingReason = health.PaperPhase1ValidPositiveBestFirstBlockingReason,
            paperPhase1InvalidPositiveArtifactsTotal = health.PaperPhase1InvalidPositiveArtifactsTotal,
            paperPhase1InvalidPositiveArtifactsAboveMinEdge = health.PaperPhase1InvalidPositiveArtifactsAboveMinEdge,
            paperPhase1InvalidPositiveArtifactsByReason = health.PaperPhase1InvalidPositiveArtifactsByReason,
            paperPhase1InvalidPositiveArtifactBestAfterSafetyEdge = health.PaperPhase1InvalidPositiveArtifactBestAfterSafetyEdge,
            paperPhase1InvalidPositiveArtifactBestCandidateId = health.PaperPhase1InvalidPositiveArtifactBestCandidateId,
            paperPhase1InvalidPositiveArtifactBestFirstReason = health.PaperPhase1InvalidPositiveArtifactBestFirstReason,
            bestValidCleanAfterSafetyEdge = health.BestValidCleanAfterSafetyEdge,
            bestInvalidArtifactAfterSafetyEdge = health.BestInvalidArtifactAfterSafetyEdge,
            bestStrategySummaryAfterSafetyEdge = health.BestStrategySummaryAfterSafetyEdge,
            bestRealWatchAfterSafetyEdge = health.BestRealWatchAfterSafetyEdge,
            bestExecutableLikeAfterSafetyEdge = health.BestExecutableLikeAfterSafetyEdge,
