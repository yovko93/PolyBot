...
public static class RuntimeSoakStatusExporter
{
    ...
    public static string Export(BotRuntimeState state, TradingBotOptions options, string contentRootPath)
    {
        ...
        var payload = new
        {
            ...
            paperPhase1ContractFixtureEnabled = health.PaperPhase1ContractFixtureEnabled,
            paperPhase1ContractFixtureDryReplayOnly = health.PaperPhase1ContractFixtureDryReplayOnly,
            paperPhase1ContractFixtureAllowPaperOpen = health.PaperPhase1ContractFixtureAllowPaperOpen,
            paperPhase1ContractFixtureOpened = health.PaperPhase1ContractFixtureOpened,
            paperPhase1ContractFixtureConsistent = health.PaperPhase1ContractFixtureConsistent,
            paperPhase1ContractFixtureConsistencyReason = health.PaperPhase1ContractFixtureConsistencyReason,
            paperPhase1ContractFixtureAlertLevel = health.PaperPhase1ContractFixtureAlertLevel,
            paperPhase1ContractFixtureStageReached = health.PaperPhase1ContractFixtureStageReached,
            ...
            paperPhase1OperatorRunbookIntervalSeconds = health.PaperPhase1OperatorRunbookIntervalSeconds,
            paperPhase1OperatorRunbookLogsWritten = health.PaperPhase1OperatorRunbookLogsWritten,
            paperPhase1OperatorRunbookLogsSuppressed = health.PaperPhase1OperatorRunbookLogsSuppressed,
            paperPhase1OperatorRunbookLastEmittedUtc = health.PaperPhase1OperatorRunbookLastEmittedUtc,
            paperPhase1OperatorRunbookLastReason = health.PaperPhase1OperatorRunbookLastReason,
            paperPhase1OperatorRunbookConsistent = health.PaperPhase1OperatorRunbookConsistent,
            paperPhase1OperatorRunbookConsistencyReason = health.PaperPhase1OperatorRunbookConsistencyReason,
            paperPhase1OperatorRunbookExportWritten = health.PaperPhase1OperatorRunbookExportWritten,
            paperPhase1OperatorRunbookExportPath = health.PaperPhase1OperatorRunbookExportPath,
            paperPhase1OperatorRunbookLastWriteError = health.PaperPhase1OperatorRunbookLastWriteError,
            ...
            paperPhase1RealSettlementFailed = health.PaperPhase1RealSettlementFailed,
            paperPhase1RealSettlementRejected = health.PaperPhase1RealSettlementRejected,
            paperPhase1RealSettlementLastPositionId = health.PaperPhase1RealSettlementLastPositionId,
            paperPhase1RealSettlementLastReason = health.PaperPhase1RealSettlementLastReason,
            paperPhase1RealSettlementLastRealizedPayout = health.PaperPhase1RealSettlementLastRealizedPayout,
            paperPhase1RealSettlementLastRealizedPnl = health.PaperPhase1RealSettlementLastRealizedPnl,
            paperPhase1RealSettlementConsistent = health.PaperPhase1RealSettlementConsistent,
            paperPhase1RealSettlementConsistencyReason = health.PaperPhase1RealSettlementConsistencyReason,
            paperPhase1LifecycleBalanceOk = health.PaperPhase1LifecycleBalanceOk,
            paperPhase1LifecycleBalanceReason = health.PaperPhase1LifecycleBalanceReason,
            ...
            paperPhase1PositiveInvalidArtifactsTotal = health.PaperPhase1PositiveInvalidArtifactsTotal,
            paperPhase1PositiveCleanCapturesTotal = health.PaperPhase1PositiveCleanCapturesTotal,
            paperPhase1PositiveCleanAboveMinEdge = health.PaperPhase1PositiveCleanAboveMinEdge,
            paperPhase1PositiveCleanBestAfterSafetyEdge = health.PaperPhase1PositiveCleanBestAfterSafetyEdge,
            paperPhase1PositiveCleanBestCandidateId = health.PaperPhase1PositiveCleanBestCandidateId,
            paperPhase1PositiveCleanBestFirstBlockingReason = health.PaperPhase1PositiveCleanBestFirstBlockingReason,
            paperPhase1PositiveRealWatchTotal = health.PaperPhase1PositiveRealWatchTotal,
            paperPhase1PositiveRealWatchAboveMinEdge = health.PaperPhase1PositiveRealWatchAboveMinEdge,
            paperPhase1PositiveRealWatchBestAfterSafetyEdge = health.PaperPhase1PositiveRealWatchBestAfterSafetyEdge,
            paperPhase1PositiveRealWatchBestCandidateId = health.PaperPhase1PositiveRealWatchBestCandidateId,
            paperPhase1PositiveExecutableLikeTotal = health.PaperPhase1PositiveExecutableLikeTotal,
            paperPhase1PositiveExecutableLikeBestAfterSafetyEdge = health.PaperPhase1PositiveExecutableLikeBestAfterSafetyEdge,
            paperPhase1PositivePaperEligibleTotal = health.PaperPhase1PositivePaperEligibleTotal,
            paperPhase1PositiveOpenedTotal = health.PaperPhase1PositiveOpenedTotal,
            paperPhase1CleanPositiveExcludedFromRealWatchTotal = health.PaperPhase1CleanPositiveExcludedFromRealWatchTotal,
            paperPhase1CleanPositiveExcludedFromRealWatchByReason = health.PaperPhase1CleanPositiveExcludedFromRealWatchByReason,
            paperPhase1BestCleanPositiveExcludedFromRealWatchCandidateId = health.PaperPhase1BestCleanPositiveExcludedFromRealWatchCandidateId,
            paperPhase1BestCleanPositiveExcludedFromRealWatchAfterSafetyEdge = health.PaperPhase1BestCleanPositiveExcludedFromRealWatchAfterSafetyEdge,
            paperPhase1BestCleanPositiveExcludedFromRealWatchReason = health.PaperPhase1BestCleanPositiveExcludedFromRealWatchReason,
            paperPhase1BestCleanPositiveExcludedFromRealWatchAllReasons = health.PaperPhase1BestCleanPositiveExcludedFromRealWatchAllReasons,
