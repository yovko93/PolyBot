...
public record VerifiedBasketScreenerDto(string ActiveProfile,DateTime Timestamp,IReadOnlyList<object> VerifiedGroups,IReadOnlyList<object> Ranking,IReadOnlyList<string> RecommendedActions);
