...
public record ScannerStatsDto(int MarketsScanned,int OrderbooksScanned,int OpportunitiesDetected,int ExecutableOpportunities,int SkippedByRisk,int NegativeEdgeSkipped,int ZeroEdgeSkipped,int PositiveEdgeFound,int ExecutableFound,int SkippedPositiveEdgeCount,int HiddenFromUiCount,long ScanDurationMs,DateTime LastScanStartedAt,DateTime LastScanCompletedAt,string? LastError,long Sequence);
